export const personalInfo = {
  ...
  projects: [
    { name: 'Lozenge', description: 'Native macOS teleprompter that follows your voice through the script, plus a live listener for calls — transcript, research cards from your own docs, and a wrap-up brief. Every window is excluded from screen sharing, and model calls use your own key or local Ollama', url: 'https://lozenge.ai', tech: ['Swift', 'SwiftUI', 'Apple Speech', 'Whisper', 'Ollama', 'MCP'] },
