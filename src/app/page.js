            ...
            {[
              {
                ...
                description: 'Building with the latest frameworks and tools including React, Next.js, and Node.js',
              },
              {
                icon: <CloudIcon sx={{ fontSize: 48 }} />,
                title: 'Cloud Solutions',
                description: 'Expertise in cloud platforms and microservices architecture',
              },
              {
                icon: <TerminalIcon sx={{ fontSize: 48 }} />,
                title: 'Clean Code',
