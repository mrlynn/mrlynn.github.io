---
title: "I Built LanceScope Because I Couldn't See What My Queries Were Costing"
description: "A Lance table can hold 2.65 GB of video while a search over it reads none. Most database tools show you the same result either way. LanceScope shows you the difference, measured from Lance's own IO counters."
...
I spent most of the spring building a conference demo I called Ctrl-F for Video. You
type "a diagram with boxes and arrows," you get back actual frames from a corpus of
recorded talks, you click one, and the video starts playing at that exact second. The
whole point of the demo was that the video and its index are the same table. Not a
video store next to a vector store. One table.

The demo worked. What I couldn't do was prove the interesting part. When I told people
that a semantic search over the entire corpus never touched a single video byte,
they'd nod politely, and I could tell they'd filed it under "sure, in theory." I had
no way to put the number on screen. Everything I had for looking at a Lance dataset
would happily tell me the query returned ten rows in a millisecond and stop there.
...
I built this because LanceDB lets you put architectures together that weren't
practical before, and I couldn't see what any of them were doing. If you've got a table
