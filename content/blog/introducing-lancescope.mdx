...
<PostImage
  src="/images/blog/lancescope/console-blob-ratio.png"
  alt="The LanceScope console showing the segments table with a video_blob column marked BLOB — SIDE FILE, 2.65 GB in blob side files against 69.8 KB of ordinary Lance files"
  width={1600}
  height={1013}
/>
...
<PostImage
  src="/images/blog/lancescope/console-rows.png"
  alt="The rows tab on the segments table, showing a plain-English question box above an SQL predicate box, with rows listed below and a read cost of 8.2 KB across 3 IOs"
  width={1600}
  height={864}
/>
...
<PostImage
  src="/images/blog/lancescope/console-findings.png"
  alt="The insights tab listing findings for the moments table: one fragment so one worker, and vector has no vector index, each with the metadata numbers it was computed from"
  width={1600}
  height={795}
/>
