...
description: "I knew Skills and Rules before I joined Cursor. What I didn't know was how hard they get on a large enterprise team. Here's what I found after digging into how teams that make them work actually set things up."
...
I thought I understood Skills and Rules before I joined Cursor.

I'd written them. I'd used them on my own projects. I really felt like I understand the power behind them.  Rules are basically always-on constraints, Skills are procedures you invoke when the work matches. File goes in `.cursor/`, agent reads it, life gets easier. For a single developer, that story mostly holds.

What I didn't understand was the hard part. Not the markdown. Not the frontmatter. The hard part shows up when a few hundred engineers share a codebase and nobody has decided who owns the agent knowledge.
...
The best advice I can give any engineer or building is before you write a single file, figure out what you're actually trying to do.  Sounds simple... but think about it from the perspective of behaviors first.
