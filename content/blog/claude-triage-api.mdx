...
Before anything else, go do this: [twenty support tickets, unsorted, the way an agent sees them](https://triage.mlynn.dev/playground/queue). One of them is a parent reporting that their child got sick. See how long it takes you to find it.
